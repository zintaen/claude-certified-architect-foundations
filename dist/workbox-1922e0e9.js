define(['exports'], function (t) {
  ...
  function x(t) {
    return t !== IDBDatabase.prototype.transaction || 'objectStoreNames' in IDBTransaction.prototype
      ? (
        ...
        ? function (...e) {
            return (t.apply(k(this), e), I(R.get(this)));
          }
        : function (...e) {
            return I(t.apply(k(this), e));
          }
      : function (e, ...s) {
          const n = t.call(k(this), e, ...s);
  ...
  function I(t) {
    ...
    const e = U(t);
    return (e !== t && (v.set(t, e), D.set(e, t)), e);
  }
  const k = (t) => D.get(t);
  function B(t, e, { blocked: s, upgrade: n, blocking: i, terminated: r } = {}) {
  ...
  function O(t, e) {
    ...
    const s = e.replace(/FromIndex$/, ''),
      n = e !== s,
      i = N.includes(s);
    if (!(s in (n ? IDBIndex : IDBObjectStore).prototype) || (!i && !L.includes(s))) return;
  ...
  E = ((t) =>
    p({}, t, {
      get: (e, s, n) => O(e, s) || t.get(e, s, n),
      has: (e, s) => !!O(e, s) || t.has(e, s),
    }))(E);
  try {
  ...
  class M {
    ...
    l(t) {
      const e = t.createObjectStore(T, { keyPath: 'id' });
    ...
    async setTimestamp(t, e) {
      const s = { url: (t = j(t)), timestamp: e, cacheName: this.u, id: this.m(t) },
        n = (await this.getDb()).transaction(T, 'readwrite', { durability: 'relaxed' });
      (await n.store.put(s), await n.done);
    }
    async getTimestamp(t) {
      const e = await this.getDb(),
        s = await e.get(T, this.m(t));
      return null == s ? void 0 : s.timestamp;
    }
    async expireEntries(t, e) {
      const s = await this.getDb();
      let n = await s.transaction(T).store.index('timestamp').openCursor(null, 'prev');
      const i = [];
      let r = 0;
      for (; n; ) {
        const s = n.value;
      ...
      const a = [];
      for (const t of i) (await s.delete(T, t.id), a.push(t.url));
      return a;
    }
    m(t) {
      return this.u + '|' + j(t);
    ...
    async getDb() {
      return (
        this.h || (this.h = await B('workbox-expiration', 1, { upgrade: this.p.bind(this) })),
        this.h
      );
    }
  }
  class P {
    ...
    async expireEntries() {
      ...
      for (const t of e) await s.delete(t, this._);
      ((this.R = !1), this.q && ((this.q = !1), d(this.expireEntries())));
    }
    ...
    async delete() {
      ((this.q = !1), await this.U.expireEntries(1 / 0));
    }
  }
  try {
  ...
  class S {
    constructor(t = {}) {
      ((this.I = t.statuses), (this.k = t.headers));
    }
    isResponseCacheable(t) {
      let e = !0;
      return (
        this.I && (e = this.I.includes(t.status)),
        this.k && e && (e = Object.keys(this.k).some((e) => t.headers.get(e) === this.k[e])),
        e
      );
    }
  }
  ...
  class $ {
    constructor(t, e) {
      ((this.B = {}),
        ...
        (this.O = [...t.plugins]),
        (this.T = new Map()));
      for (const t of this.O) this.T.set(t, {});
      this.event.waitUntil(this.N.promise);
    }
    async fetch(t) {
      const { event: e } = this;
      let n = F(t);
        ...
        l = u
          ? await (async function (t, e, s, n) {
              ...
              const r = Object.assign(Object.assign({}, n), { ignoreSearch: !0 }),
                a = await t.keys(e, r);
              for (const e of a) if (i === K(e.url, s)) return t.match(e, n);
    ...
    async getCacheKey(t, e) {
      ...
      if (!this.B[s]) {
        ...
        for (const t of this.iterateCallbacks('cacheKeyWillBeUsed'))
          n = F(await t({ mode: e, request: n, event: this.event, params: this.params }));
        this.B[s] = n;
      }
      return this.B[s];
    }
  ...
  class H {
    ...
    handleAll(t) {
      ...
      const e = t.event,
        ...
        i = new $(this, { event: e, request: s, params: n }),
        r = this.M(i, s, e);
  ...
  class z {
    ...
    async getDb() {
      return (
        this.h || (this.h = await B('workbox-background-sync', 3, { upgrade: this.l })),
        this.h
      );
    }
    l(t, e) {
      e > 0 && e < 3 && t.objectStoreNames.contains(Q) && t.deleteObjectStore(Q);
      t.createObjectStore(Q, { autoIncrement: !0, keyPath: 'id' }).createIndex(G, G, {
        unique: !1,
      });
    }
  }
  class V {
    constructor(t) {
      ((this.K = t), (this.W = new z()));
    }
    async pushEntry(t) {
      (delete t.id, (t.queueName = this.K), await this.W.addEntry(t));
    }
    async unshiftEntry(t) {
      const e = await this.W.getFirstEntryId();
      (e ? (t.id = e - 1) : delete t.id, (t.queueName = this.K), await this.W.addEntry(t));
    }
    async popEntry() {
      return this.A(await this.W.getLastEntryByQueueName(this.K));
    }
    async shiftEntry() {
      return this.A(await this.W.getFirstEntryByQueueName(this.K));
    }
    async getAll() {
      return await this.W.getAllEntriesByQueueName(this.K);
    }
    async size() {
      return await this.W.getEntryCountByQueueName(this.K);
    }
    async deleteEntry(t) {
      await this.W.deleteEntry(t);
    }
    async A(t) {
  ...
  ((t.BackgroundSyncPlugin = class {
    ...
    (t.ExpirationPlugin = class {
      ...
      gt(t) {
        ...
        let e = this.qt.get(t);
        return (e || ((e = new P(t, this.Rt)), this.qt.set(t, e)), e);
      }
      yt(t) {
        if (!this.D) return !0;
        const e = this.bt(t);
    ...
    (t.NavigationRoute = class extends i {
      constructor(t, { allowlist: e = [/./], denylist: s = [] } = {}) {
        (super((t) => this.vt(t), t), (this.Dt = e), (this.Et = s));
      }
      vt({ url: t, request: e }) {
        if (e && 'navigate' !== e.mode) return !1;
        const s = t.pathname + t.search;
        for (const t of this.Et) if (t.test(s)) return !1;
        return !!this.Dt.some((t) => t.test(s));
      }
    }),
    (t.NetworkOnly = class extends H {
      constructor(t = {}) {
        (super(t), (this.xt = t.networkTimeoutSeconds || 0));
      }
      async S(t, e) {
        let n, i;
        try {
          const s = [e.fetch(t)];
          if (this.xt) {
            const t = A(1e3 * this.xt);
            s.push(t);
          }
          if (((i = await Promise.race(s)), !i))
            throw new Error(`Timed out the network response after ${this.xt} seconds.`);
        } catch (t) {
          t instanceof Error && (n = t);
        }
        if (!i) throw new s('no-response', { url: t.url, error: n });
    ...
    (t.createHandlerBoundToURL = function (t) {
      return lt().createHandlerBoundToURL(t);
    }),
